...
public class ctrConfig {
   ...
   public void cambiarPw(){
       ...
       this.menu.setCorreo(this.vista4.getTxtCorreo().getText());
       this.menu.setContrasenia(this.vista7.getTxtConNueva().getText());
       this.menu.setConRepite(this.vista7.getTxtConRepite().getText());
       
       if(!this.menu.getContrasenia().equals(this.menu.getConRepite())){
   ...
   public void chat(){
    ...
    public void añadirReporte(){
        this.menu.setContenido(this.vista8.getTxtReporte().getText());
       // this.menu.setId_tipo(this.vista9.getTipoReporte().getText());
        
        if(this.consulta.agregar(menu)){
            JOptionPane.showMessageDialog(null, "Reporte enviado, Gracias por tu informaciión");
        }else{
            JOptionPane.showMessageDialog(null, "Error al enviar reporte");
        }
        this.limpiar();
