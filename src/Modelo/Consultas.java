...
public class Consultas extends Conexion{
    ...
    public boolean cambiar(Funciones menu){
        ...
        public boolean agregar(Funciones menu){
        Connection con = getConexion();
        
        String sql = "INSERT INTO reporte  (id_usuario,id_tipo,id_estado,contenido) VALUES (?,?,?,?,?)";
        
        try{
            PreparedStatement ps = con.prepareStatement(sql);
            ps.setInt(2, menu.getId_usuario());
            //ps.setInt(3, menu.getTipoReporte()); 
            ps.setString(5, menu.getContenido());
